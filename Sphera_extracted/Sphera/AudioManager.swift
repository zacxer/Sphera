...
class AudioManager: ObservableObject {
    ...
    private enum PowerUpSound {
        static let freeze: SystemSoundID = 1104
        static let shuffle: SystemSoundID = 1109
        static let undoAll: SystemSoundID = 1107
        static let magicWand: SystemSoundID = 1115
        static let colorBomb: SystemSoundID = 1102
        static let win: SystemSoundID = 1025
        static let error: SystemSoundID = 1053
        static let coin: SystemSoundID = 1057
        static let tubeComplete: SystemSoundID = 1114  // Suono completamento tubo
    }
