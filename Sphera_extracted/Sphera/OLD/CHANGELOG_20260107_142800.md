...
### Temporaneo (Screenshot App Store)
- **⚠️ ADS COMMENTATI - DA RIATTIVARE!**
  - `ContentView.swift`: BannerAdView commentato (linea 32)
  - `PowerUpViews.swift`: Bottone AD play.circle.fill commentato
  - `PowerUpViews.swift`: Bottone "Guarda AD +25" nello shop commentato
  - Cercare `// SCREENSHOT:` per trovare i punti da riattivare
...
*Ultimo aggiornamento: 2026-01-06 (v1.0.4)*
