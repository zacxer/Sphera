...
struct TubesContainerView: View {
    ...
    private func calculateLayout(columns: Int) -> (horizontalSpacing: CGFloat, verticalSpacing: CGFloat, scale: CGFloat) {
        switch columns {
        case 1...3:
            return (horizontalSpacing: 10, verticalSpacing: -30, scale: 1.0)
        case 4:
            return (horizontalSpacing: 2, verticalSpacing: -35, scale: 0.88)
        case 5:
            return (horizontalSpacing: -4, verticalSpacing: -40, scale: 0.75)
        case 6:
            return (horizontalSpacing: -8, verticalSpacing: -45, scale: 0.68)
        default:
            return (horizontalSpacing: -10, verticalSpacing: -50, scale: 0.62)
        }
    }
}
