...
struct Level {
    ...
    init(number: Int, difficulty: Difficulty = .medium) {
        ...
        // Stima mosse ottimali basata sulla complessità del puzzle
        // Usa le mosse di shuffle come base (il giocatore dovrebbe fare circa il 60-70% di quelle)
        let baseMoves: Int
        switch difficulty {
        case .easy:
        ...
        // Mosse ottimali = circa 60% delle mosse di shuffle (arrotondato)
        self.optimalMoves = max(8, (baseMoves * 60) / 100)
    }
