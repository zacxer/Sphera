    ...
    var body: some View {
        ZStack {
            ...
            VStack(spacing: 20) {
                ...
                // LOGO "SPHERA" - Ultra Premium
                ZStack {
                    // Outer glow massimo (layer 0)
                    Text("SPHERA")
                        .font(.system(size: 64, weight: .black, design: .rounded))
                        .foregroundColor(Color(hex: "8B5CF6"))
                        .blur(radius: 50)
                        .opacity(glowPulse ? 0.7 : 0.5)

                    // Glow pulsante viola (layer 1)
                    Text("SPHERA")
                        .font(.system(size: 64, weight: .black, design: .rounded))
                        .foregroundColor(Color(hex: "A855F7"))
                        .blur(radius: glowPulse ? 35 : 28)
                        .opacity(0.95)
                        .scaleEffect(glowPulse ? 1.08 : 1.0)

                    // Glow magenta (layer 2)
                    Text("SPHERA")
                        .font(.system(size: 64, weight: .black, design: .rounded))
                        .foregroundColor(Color(hex: "EC4899"))
                        .blur(radius: 22)
                        .opacity(glowPulse ? 0.5 : 0.3)
                        .offset(x: glowPulse ? -3 : 3)

                    // Glow blu elettrico (layer 3)
                    Text("SPHERA")
                        .font(.system(size: 64, weight: .black, design: .rounded))
                    ...
                    // Glow ciano neon (layer 4)
                    Text("SPHERA")
                        .font(.system(size: 64, weight: .black, design: .rounded))
                        .foregroundColor(Color(hex: "22D3EE"))
                        .blur(radius: 12)
                        .opacity(glowPulse ? 0.5 : 0.25)
                        .offset(x: glowPulse ? 4 : -4, y: -2)

                    // Testo principale con gradient ultra premium
                    Text("SPHERA")
                        .font(.system(size: 64, weight: .black, design: .rounded))
                        .foregroundStyle(
                            LinearGradient(
