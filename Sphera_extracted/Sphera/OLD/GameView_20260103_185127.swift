...
struct TubesContainerView: View {
    ...
    private func calculateLayout(columns: Int, rows: Int, hasTallTube: Bool) -> (horizontalSpacing: CGFloat, verticalSpacing: CGFloat, scale: CGFloat) {
        ...
        switch columns {
        case 1...3:
            baseLayout = (horizontalSpacing: 10, verticalSpacing: -30, scale: 1.0)
        case 4:
            baseLayout = (horizontalSpacing: 2, verticalSpacing: -35, scale: 0.88)
        case 5:
            baseLayout = (horizontalSpacing: -4, verticalSpacing: -40, scale: 0.75)
        case 6:
            baseLayout = (horizontalSpacing: -8, verticalSpacing: -45, scale: 0.68)
        default:
            baseLayout = (horizontalSpacing: -10, verticalSpacing: -50, scale: 0.62)
        }

        // Riduci scala se ci sono 2+ righe
        if rows >= 2 {
            let rowScaleFactor: CGFloat = hasTallTube ? 0.72 : 0.78
